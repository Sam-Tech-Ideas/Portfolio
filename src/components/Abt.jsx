  ...
  return (
    <div>
     ...
     <h1 className='text-7xl text-gray-600  text-center font-extrabold py-10'>ABOUT ME</h1>
      ...
      <p className='text-base sm:text-xl  text-center text-gray-300 leading-relaxed mt-4 '>I'm a second year computer science student and a passionatate fullstack web developer focused on creating secured and scalable web applications using Python(Django) for backend and 
